...
import { Lock, UserPlus, Users2 } from "../../components/icons";
      ...
      {activeTab === "players" ? (
        <section className="mt-8 grid gap-6">
          <div className="card">
            ...
            <div className="mt-4 grid gap-3 sm:grid-cols-2">
              <div className="rounded-2xl border border-slate-200/60 bg-slate-50 px-4 py-3 dark:border-ink-700/60 dark:bg-ink-900/30">
                <p className="text-[11px] font-semibold uppercase tracking-wide text-slate-500 dark:text-slate-300">Active Players</p>
                <p className="mt-1 text-2xl font-semibold">{activePlayers.length}</p>
              </div>
              <div className="rounded-2xl border border-slate-200/60 bg-slate-50 px-4 py-3 dark:border-ink-700/60 dark:bg-ink-900/30">
                <p className="text-[11px] font-semibold uppercase tracking-wide text-slate-500 dark:text-slate-300">Inactive Players</p>
          ...
          <div className="card">
            ...
            <p className="mt-2 text-sm text-slate-500 dark:text-slate-300">Create a new player profile for join/withdraw and Splitwise mapping.</p>
